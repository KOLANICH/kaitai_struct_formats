...
-license-header: | # the conditions contradict each other and seem to be unenforceable
...
doc-ref:
  - https://mglavionics.co.za/Docs/Enigma%20Waypoint%20format.pdf
  ...
  waypoint:
    seq:
      ...
      - id: name_long
        type: dc_str(27)
        doc: |
          The long name contains a human readable description of the waypoint.
          For example: “Los Angeles International”. The long name is arbitrary and not used as search key for any purpose."

    instances:
      is_data_frequency:
        value: 25 >= type.to_i and type.to_i >= 9
      altitude:
        value: "((data_raw < 0x8FFFFFFF)?data_raw:-0x8FFFFFFF - data_raw)"
        doc: in feet
